  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>今日推荐</div>
        
        	<div class="feat_prod_box">
            
            	<div class="prod_img"><a href="booklist.jsp"><img src="images/duchangtuan1.jpg" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                	<div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">独唱团</div>
                    <p class="details">几天前有人和我说起，当年上大学的时候，是个文学青年，理想做一个作家和记者，那时候我们都好吃香啊，如果再能写点小诗，弹点小吉他，摘些小花，女生们都被迷倒了。你看看现在，女生们再也不中意这些人了，她们中意的是……我说，那你们还写点小诗，弹点小吉他，摘些小花么？他说，……。所以说，这个世界就是这样的，男性改变世界，女性改变男性的世界观。</p>
                    <a href="booklist.jsp" class="more">- 更多图书 -</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
            	...
            	<div class="prod_img"><a href="booklist.jsp"><img src="images/dafenqimima.jpg" alt="" title="" border="0" width="100" height="110"/></a></div>
                
                <div class="prod_det_box">
                	<div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">达芬奇密码</div>
                    <p class="details">哈佛大学的符号学专家罗伯特.兰登在法国巴黎出差期间的一个午夜接到一个紧急电话，得知卢浮宫博物馆年迈的馆长被人杀害在卢浮宫的博物馆里，人们在他的尸体旁边发现了一个难以捉摸的密码。兰登与法国一位颇有天分的密码破译专家索菲.奈芙，在对一大堆怪异的密码进行整理的过程当中，居然发现一连串的线索......</p>
                    <a href="booklist.jsp" class="more">- 更多图书 -</a>
                    <div class="clear"></div>
                    </div>
           ...
           <div class="new_products">
                    ...
                    <div class="new_prod_box">
                        <a href="booklist.jsp">追风筝的人</a>
                        <div class="new_prod_bg">
                        <span class="new_icon"><img src="images/new_icon.gif" alt="" title="" /></span>
                        <a href="booklist.jsp"><img src="images/zhuifengzhengderen.jpg" alt="" title="" class="thumb" border="0" height="90" width="85"></a>
                        </div>           
                    </div>          
